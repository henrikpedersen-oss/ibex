...
#
# JasperGold formal check for ibex_icache.
# Run with: jg cache-ctrl/check.tcl -allow_unsupported_OS -acquire_proj [-no_gui]
...
elaborate -top ibex_icache -disable_auto_bbox
