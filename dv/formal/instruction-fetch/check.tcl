...
#
# JasperGold formal check for ibex_if_stage.
# Run with: jg instruction-fetch/check.tcl -allow_unsupported_OS -acquire_proj [-no_gui]
...
elaborate -top ibex_if_stage -disable_auto_bbox
